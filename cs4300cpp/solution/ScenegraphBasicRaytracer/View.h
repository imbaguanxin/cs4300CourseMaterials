...
#include "sgraph/RTScenegraphRenderer.h"
...
private:
    void drawOpenGL(util::OpenGLFunctions& e);
...
private:
    ...
    sgraph::GLScenegraphRenderer openGLRenderer;
    sgraph::RTScenegraphRenderer raytraceRenderer;
