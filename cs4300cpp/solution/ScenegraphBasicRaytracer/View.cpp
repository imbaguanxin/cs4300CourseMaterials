...
void View::initScenegraph(util::OpenGLFunctions &gl, const string& filename) throw(runtime_error)
{
  ...
  openGLRenderer.setContext(&gl);
  map<string,string> shaderVarsToVertexAttribs;
  shaderVarsToVertexAttribs["vPosition"] = "position";
  shaderVarsToVertexAttribs["vNormal"] = "normal";
  shaderVarsToVertexAttribs["vTexCoord"] = "texcoord";
  openGLRenderer.initShaderProgram(program,shaderVarsToVertexAttribs);
  scenegraph->setRenderer<VertexAttrib>(&openGLRenderer,sinfo.meshes);
  scenegraph->setRaytracer(&raytraceRenderer);
  program.disable(gl);
...
void View::init(util::OpenGLFunctions& gl) throw(runtime_error)
{
  ...
  program.createProgram(gl,
                        string("shaders/lights-textures.vert"),
...
void View::draw(util::OpenGLFunctions& gl)
{
  ...
  modelview.top() = modelview.top() *
      glm::lookAt(glm::vec3(-50.0f,120.0f,200.0f),
...
void View::drawOpenGL(util::OpenGLFunctions& gl)
{
